...
call s:SetHighlight('BufferActive',        '', s:bg, '')
call s:SetHighlight('BufferActiveMod',     '', s:bg, '')
call s:SetHighlight('BufferActiveSign',    '', s:bg, '')
call s:SetHighlight('BufferActiveIndex',   '', s:bg, '')
