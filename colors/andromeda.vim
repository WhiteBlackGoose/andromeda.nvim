...
call s:SetHighlight('BufferActive',        '', s:light_bg, '')
call s:SetHighlight('BufferActiveMod',     '', s:light_bg, '')
call s:SetHighlight('BufferActiveSign',    '', s:light_bg, '')
call s:SetHighlight('BufferActiveIndex',   '', s:light_bg, '')
